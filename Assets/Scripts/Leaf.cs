...
public class                        Leaf : MonoBehaviour
{
    ...
    {
        if (collider.gameObject.CompareTag("collectiblePollen")) { this.plant.pollenReserve += this.pollenAmount; if (this.plant.pollenReserve >6) this.plant.pollenReserve = 6;}
